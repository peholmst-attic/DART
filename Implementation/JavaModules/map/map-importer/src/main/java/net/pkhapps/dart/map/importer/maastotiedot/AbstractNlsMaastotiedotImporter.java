...
public abstract class AbstractNlsMaastotiedotImporter<R extends UpdatableRecord<R>> extends AbstractJooqImporter {
    ...
    protected void importData(DSLContext dslContext) throws Exception {
        ...
        File dataFile = new File("/Users/petterprivate/Google Drive/Maps/maastotietokanta_tiesto/K34.xml");
    ...
    protected abstract R createRecord(SimpleFeature feature, DSLContext dslContext) throws Exception;
